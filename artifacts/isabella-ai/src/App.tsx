...
/*
 * One-time migration:
 * Existing Isabella users may already have an older plugin list saved
 * before Hugging Face was added. We add Hugging Face once, then preserve
 * the user's choices normally.
 */
...
async function streamAgent(
  ...
  const response = await fetch('/api/agent/stream', {
    ...
    body: JSON.stringify({
      ...
      // Smaller agent loop for faster Nemotron responses.
      maxSteps: 4,
    }),
  });
            ...
            >
              ...
              >
                <div>
                  ...
                  >
                    Choose which capabilities Isabella
                    can use.
                  </span>
                </div>
    ...
    <div className="composer-wrap">
      <div className="composer">
        ...
        <div className="composer-actions">
          <button
            className="icon-button"
            aria-label="Hold to talk with Isabella"
            onPointerDown={
              beginMicPress
            }
            onPointerUp={
  ...
  return new Promise<string>(
    (resolve, reject) => {
      ...
      reader.onerror = () =>
        reject(
          new Error(
            'Could not read the microphone recording.',
          ),
        );
  ...
  const startListening =
    async () => {
      ...
      try {
        ...
        setError(
          'Microphone access is needed for live conversation.',
        );
    ...
    >
      ...
      >
        ...
        <p className="voice-hint">
          {error ||
            (phase === 'listening'
              ? 'Speak naturally, then release to send.'
              : 'Your conversation stays private in this browser.')}
        </p>
      ...
      <audio
        ...
        onError={() => {
          setError(
            'Audio playback was blocked. Tap the microphone to continue.',
          );
          setPhase('error');
        }}
      />
    ...
    <section className="page content">
      <div className="page-heading">
        <div>
          ...
          <p className="page-intro">
            ...
            curiosity, or a
            half-formed idea.
            Isabella will make a
            considered first pass,
            with sources when you
            want to go deeper.
          </p>
        </div>
      </div>
      ...
      >
        ...
        <div style={{ flex: 1 }}>
          ...
          <p className="result-snippet">
            Take your question
            back to the quiet chat
            space and Isabella will
            work from her local
            knowledge.
          </p>
        </div>
...
function Tools() {
  ...
  const tools: {
  ...
  }[] = [
    {
      title: 'Daily plan',
      icon: ListTodo,
      copy: 'Turn an intention into a gentle, realistic sequence of next steps.',
      action: 'Plan my day',
      prompt:
        'Help me plan my day',
      mode: 'Plan',
    },
    {
      ...
      icon: Lightbulb,
      copy: 'Get a layered explanation that meets you where you are.',
      action:
        'Explain something',
      prompt:
    ...
    },
    {
      title: 'Writing room',
      icon: PenLine,
      copy: 'Shape a note, draft, outline, or message without starting from a blank page.',
      action:
        'Help me write',
      prompt:
    ...
    },
    {
      ...
      icon: Calculator,
      copy: 'Do a small bit of practical math without opening another tab.',
      action:
        'Calculate something',
      prompt:
    ...
    },
    {
      ...
      icon: CalendarDays,
      copy: 'Make a little space to notice what is working and what needs care.',
      action:
        'Give me a prompt',
      prompt:
        'Give me a thoughtful reflection prompt',
      mode: 'Ask',
    },
    {
      title: 'Save a thought',
      icon: Bookmark,
      copy: 'Keep a useful idea in your local library for later.',
      action:
        'Open library',
    },
  ];
    ...
    <section className="page content">
      <div className="page-heading">
        <div>
          ...
          <p className="page-intro">
            A handful of focused
            ways to move from
            “I should” to something
      ...
      <div className="page-heading">
        <div>
          ...
          <p className="page-intro">
            ...
            notes live here on this
            device. Nothing leaves
            your browser unless you
            choose to share it.
          </p>
        </div>
      </div>
